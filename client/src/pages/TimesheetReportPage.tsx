    ...
    <div className="p-4 space-y-3">
      ...
      <div className="flex flex-col lg:flex-row lg:items-stretch gap-5">
        ...
        <Card className="p-4 w-full lg:max-w-[720px] lg:flex-1">
          <div className="flex items-baseline justify-between mb-3 gap-3">
            <h2 className="text-helper font-semibold text-muted-foreground uppercase tracking-wide">
              Team Overview
            </h2>
            {data && (
          ...
          {isLoading ? (
            ...
            <p className="text-helper text-muted-foreground">—</p>
          ) : (
            <>
              {data.summary.length === 0 ? (
                <p className="text-helper text-muted-foreground">No team members available.</p>
              ) : (
      ...
      <Card className="p-3">
        {data && displayRows.length > 0 ? (
          ...
          <p className="text-helper text-muted-foreground">No rows.</p>
        )}
      </Card>
    </div>
  );
...
function SummaryStat({
  ...
  return (
    <div className="flex flex-col leading-tight">
      <span className="text-helper uppercase tracking-wide text-muted-foreground">
        {label}
      </span>
      <span
        className={
