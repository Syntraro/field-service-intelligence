    ...
    <MobileShell showNav>
      ...
      <div className="bg-[#0f1a2e] px-3 pt-2 pb-3">
        <div className="flex items-center gap-2">
          <button onClick={() => setLocation("/tech/search")} className="p-1 -ml-1 rounded-lg hover:bg-white/10">
        ...
        {activeTab === "History" && (
          <div className="space-y-2">
            {recentJobs.length === 0 ? (
              ...
              recentJobs.map(job => (
                <div key={job.id} className="rounded-xl border border-slate-200 bg-white p-3 flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
