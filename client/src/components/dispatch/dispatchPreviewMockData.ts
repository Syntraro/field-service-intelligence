...
export const MOCK_SCHEDULED_VISITS: DispatchVisit[] = [
  // Marcus — busy day
  {
    ...
    durationMinutes: 120, isAllDay: false, priority: "normal", version: 1,
  },
  {
    ...
    durationMinutes: 180, isAllDay: false, priority: "high", version: 1,
  },
  {
  ...
  // Sarah
  {
    ...
    durationMinutes: 90, isAllDay: false, priority: "normal", version: 1,
  },
  {
  ...
  },
  {
    ...
    durationMinutes: 150, isAllDay: false, priority: "urgent", version: 1,
  },
  ...
  // David
  {
    ...
    durationMinutes: 270, isAllDay: false, priority: "normal", version: 1,
  },
  {
  ...
  // Emily
  {
    ...
    durationMinutes: 180, isAllDay: false, priority: "normal", version: 1,
  },
  {
    ...
    durationMinutes: 60, isAllDay: false, priority: "normal", version: 1,
  },
  {
...
export const MOCK_UNSCHEDULED_VISITS: DispatchVisit[] = [
  {
    ...
    summary: "Boiler annual inspection", status: "open",
  ...
  },
  {
    ...
    summary: "Condensing unit diagnostic", status: "open",
    locationName: "Eglinton Crossing", customerName: "Freeman Service Group",
    technicianId: null, technicianIds: [], scheduledStart: null, scheduledEnd: null,
    durationMinutes: 60, isAllDay: false, priority: "high", version: 1,
  },
  {
    id: "v-u3", visitNumber: 2, jobNumber: 10475, jobId: "j-u3",
    summary: "Boiler repair — follow-up", status: "open",
    locationName: "Lakeside Heights", customerName: "Freeman Service Group",
    technicianId: null, technicianIds: [], scheduledStart: null, scheduledEnd: null,
    durationMinutes: 120, isAllDay: false, priority: "urgent", version: 1,
  },
  {
    id: "v-u4", visitNumber: 1, jobNumber: 10514, jobId: "j-u4",
    summary: "ERV unit seasonal startup", status: "open",
  ...
  },
  {
    ...
    summary: "Warehouse heater PM", status: "open",
  ...
  },
  {
    ...
    summary: "Ductless split service call", status: "open",
    locationName: "Bloor Street West", customerName: "Freeman Service Group",
    technicianId: null, technicianIds: [], scheduledStart: null, scheduledEnd: null,
    durationMinutes: 45, isAllDay: false, priority: "normal", version: 1,
  },
];
