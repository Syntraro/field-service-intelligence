...
const GROUPS: Group[] = [
  ...
  { heading: "Visits / dispatch",tables: ["job_visits", "supplier_visit_details", "events", "attention_items", "technician_positions", "technician_live_positions"] },
  ...
  { heading: "Tasks",            tables: ["tasks", "suppliers", "supplier_locations"] },
